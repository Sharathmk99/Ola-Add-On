...
public class ATMFragment extends Fragment implements CommonsInterface {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View content = inflater.inflate(R.layout.atm_layout, container, false);
		return content;
	}
	...
	private GoogleMap.OnMyLocationChangeListener myLocationChangeListener = new GoogleMap.OnMyLocationChangeListener() {
		...
		public void onMyLocationChange(Location location) {
			...
			if (isReferesh) {
				GetPlaces getPlaces = new GetPlaces(getActivity(), "atm",
						loc.latitude, loc.longitude, ATMFragment.this,
						Utils.API_KEY);
				getPlaces.execute();
				isReferesh = false;
			}
